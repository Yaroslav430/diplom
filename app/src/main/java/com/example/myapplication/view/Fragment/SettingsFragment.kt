...
class SettingsFragment(private val isNightModeOn: Boolean) : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.theme.setOnClickListener {
            ...
            AnimationHelper.performFragmentCircularRevealAnimation(binding.settingsFragmentRoot, requireActivity(), 1)
        }
    }
